...
We can do better. As an early step, we can impute gender based on author names, and explore the inclusion of works authored by men and women over time.[^3] NO. DO NOT IMPUTE GENDER BASED ON NAME. DO NOT LEAVE THIS IN HERE, PLEASE. Do you know how many women publish under their initials so as not to be discriminated against? The same goes for trans folks and non-binary invdividuals. How can this be valid data? Has Chris seen this?

[^3]: These imputations should be considered a very preliminary estimate, created for the purpose of promoting general discussion, potential issue spotting, and hypothesis generation. The process of imputation reflects only point estimates, and does not reflect uncertainty from several sources: including omissions in the original data sources, heuristic name extraction, and uncertainty in name to gender assignment. Further, the analysis treats gender as a binary category, and elides questions of adjusting for multiple authors. NO. This is exactly the type of "academic exercise" undertaken by the cis het white male establishment that utilizes assumptions or "imputations" about gender and sex to allow for Devil's Advocate arguments. Do better by the systematically oppressed and underrepresented. 
...
This preliminary estimate indicates that roughly thirty percent of open access monographs have at least one female author. This proportion remains roughly steady over time. As OA monographs are dominated by the humanities, where over fifty percent of US Ph.D. recipients (and over forty percent of faculty in most humanities disciplines) are women this indicates a need to evaluate systemic bias of who is included in open monograph publishing.[^4]
